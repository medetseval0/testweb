import svgPaths from "./svg-oxxlfg7jy2";
...
function AddlistinginstanceBackgroundImage({
  ...
  return (
    <BackgroundImage55
      additionalClassNames={["relative size-8", ...additionalClassNames]}
    >
...
function CategoriesContainer() {
  return (
    <BackgroundImage70 additionalClassNames={["h-full"]}>
...
function SearchIcon() {
  return (
    <BackgroundImage55
      additionalClassNames={["relative", "shrink-0", "size-8"]}
    >
      <g id="search-icon" opacity="0.5">
        <path
          clipRule="evenodd"
          d={svgPaths.p3881f00}
          fill="var(--fill-0, white)"
...
function Placeholder() {
  return (
    <div
      className="[grid-area:1_/_1] ml-[12.5px] mt-2.5 relative"
      data-name="placeholder"
    >
      <div className="box-border content-stretch flex flex-row gap-[5px] items-center justify-start overflow-clip p-0 relative">
        <SearchIcon />
        <div className="font-['Plus_Jakarta_Sans:Medium',_sans-serif] font-medium leading-[0] lowercase relative shrink-0 text-[#9d9d9d] text-[16px] text-left text-nowrap">
